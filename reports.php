...
<head>
    ...
    <title>Deluxe Upload : Reports Page</title>
...
<body lang="en">
    ...
    <div class="container dv2 p-1 mt-3 mb-3">
        <div class="alert-card mt-5 mb-5 mx-auto">
            <h1><i class="fas fa-flag"></i> Submit a report</h1>
            <p>Please describe the issue clearly so we can take action.</p>
            <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                ...
                <?php if (isset($_GET['fileid'])): ?>
                    <div class="mt-3 mb-3">
                        <label for="forfile" class="form-label">For file</label>
                        <input type="text" name="forfile" readonly class="form-control" id="forfile" value="<?= $filename; ?>">
                    </div>
                <?php endif; ?>
                <div class="mt-3 mb-3">
                    <label for="reasonReport" class="form-label">Reason of report</label>
                    <textarea name="reasonreport" class="form-control" id="reasonReport" placeholder="Type your report ..."><?php if ($valid) {
                                                                                                                                echo "";
                                                                                                                            } ?></textarea>
                </div>
                <div class="mt-2 mb-2">
