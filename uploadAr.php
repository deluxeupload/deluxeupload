...
<head>
    ...
    <title>ديلوكس أبلود : رفع ملف</title>
            ...
            <div class="card p-0">
                ...
                <div class="card-body">
                    <div>
                        ...
                        <p>اِضغط هنا لرفع الملف</p>
                        <input type="file" name="userfile" class="form-control d-none" id="file">
                        <p id="show-file" class="mt-2 mb-2"></p>
                    </div>
                </div>
                <div class="card-footer">
                    <button type="button" id="uploadButton" class="btn w-100" onclick="uploadFileBtn()">رفع</button>
                </div>
            </div>
        </form>
